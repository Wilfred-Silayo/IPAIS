...
<div class="container m-1">
    <div class="row justify-content-between">
        ...
        <div class="col">
            <a class="btn btn-sm  btn-success me-2" href="{{route('admin.create.crimes')}}">
                <span><i class="fa fa-sharp fa-add"></i> Create</span>
            </a>
        </div>
        <div class="col">
            <form class="d-flex" action="{{ route('admin.search.mostwanted') }}" method="GET">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            ...
                            <a href="{{route('admin.comments.mostwanted.list',$crime->id)}}"
                            ...
                            <a href="#" class="btn btn btn-outline-primary me-3" data-bs-toggle="modal"
                                ...
                                data-coincidence="{{ json_encode($crime) }}">Message Publisher</a>
                            @endif
