...
<div class="container m-1">
    <div class="row justify-content-between">
        ...
        <div class="col">
            <form class="d-flex" action="{{ route('admin.search.lost.item') }}" method="GET">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            ...
                            <a href="{{route('admin.comments.list',$lostItem->id)}}"
                            ...
                            <form action="{{route('admin.lost.item.resolve',$lostItem->id)}}" method="POST" class="p-0 m-0">
                                @csrf
