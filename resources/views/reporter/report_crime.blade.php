...
<div class="container bg-white shadow-sm py-2 mt-1">
    <div class="row justify-content-between">
        <div class="col">
            <h4 class="text-success">Crimes you reported</h3>
        </div>
        <div class="col">
...
<div class="alert alert-info mt-1">
    No Crimes found. <a class="ms-2" href="{{ route('dashboard') }}">Go To Dashboard</a>
</div>
@else
<div class="row mt-3">
    ...
    <div class="row mt-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            ...
                            <a href="#" type="button" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal"
                                ...
                                data-lost-item="{{ json_encode($crime) }}">Delete</a>
        ...
        <div class="modal fade" id="viewcrimeModal{{ $crime->id }}" tabindex="-1"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="viewcrimeModalLabel{{ $crime->id }}">View a crime</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <!-- Carousel for images -->
...
viewButtons.forEach(button => {
    button.addEventListener('click', () => {
        const crime = JSON.parse(button.getAttribute('data-lost-item'));
        ...
        modal.querySelector('.lost-item-name').textContent = crime.name;
        modal.querySelector('.lost-item-description').textContent = crime.description;
        modal.querySelector('.lost-item-category').textContent = crime.category;
        modal.querySelector('.lost-item-time').textContent = `Time Reported: ${crime.created_at}`;
    });
});
</script>