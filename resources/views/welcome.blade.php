...
<div class="container-fluid">
    ...
    <div class="row d-inline d-md-none d-lg-none d-xl-none d-xxl-none">
        ...
        <a href="{{route('welcome.found.items')}}"
            class="nav-link d-inline {{request()->routeIs('welcome.found.items')? 'active': 'text-dark'}}">Most
            wanted</a>
    ...
    <div class="row">
        ...
        <div class="col-md-3 ms-1 border d-none d-md-block d-xl-block d-lg-block d-xxl-block">
            ...
            <div class="row">
                ...
                <div class="col-12  border-bottom py-2 {{request()->routeIs('welcome.found.items')?'bg-info':''}} ">
                    <a href="{{route('welcome.found.items')}}" class="text-decoration-none text-dark">
                        <h6>Found Items</h6>
                    </a>
                </div>
