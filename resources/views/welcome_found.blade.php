...
@else
<div class="row mt-3 overflow-auto" style="height: 80vh;">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="viewfoundItemModalLabel{{ $foundItem->id }}">View a
                                        Item</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div id="carouselfoundItemImages{{ $foundItem->id }}" class="carousel slide"
                                        ...
                                        <button class="carousel-control-prev" type="button"
                                            data-bs-target="#carouselfoundItemImages{{ $foundItem->id }}"
                                            data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Previous</span>
                                        </button>
