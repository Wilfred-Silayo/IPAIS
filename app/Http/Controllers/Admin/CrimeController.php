...
class CrimeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.crime_reports', ['crimes' => $crimes]);
    }
    ...
    {
        return view('admin.create_most_wanted');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.reports.most.wanted')->with('success', 'Crime reported successfully.');
    }
    ...
    public function show()
    {
        ...
        return view('admin.most_wanted_reports', ['crimes' => $crimes]);
    }
